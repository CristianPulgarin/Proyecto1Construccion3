...
<header class="content header">
    ...
    <div class="galeria-port">
        <div align="center" class="imagen-port">
            <img src="../public/img/abpartebaja.jfif" height="900" width="1100"> 
            <div class="hover-galeria">
            
                <h2><strong>ABDOMEN PARTE BAJA</strong></h2>
                <p>Contactate con nuestros entrenadores</p>
                 </div>
        
        </div>
        <div class="imagen-port">
            <img src="../public/img/partebaja.jpg" height="800" width="1100">
            <div class="hover-galeria">
                <h2><strong>ABDOMEN PARTE BAJA</strong></h2>
                <p>Contactate con nuestros entrenadores</p>
        ...
        <div class="imagen-port">
            <img src="../public/img/OB.jpg" height="800" width="1100">
            <div class="hover-galeria">
                <h2><strong>OBLICUOS</strong></h2>
                <p>Contactate con nuestros entrenadores</p>
                
            </div>
        </div>
        <div class="imagen-port">
            <img src="../public/img/PLANCHA.JPG">
            <div class="hover-galeria">
