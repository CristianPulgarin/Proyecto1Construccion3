...
<header class="content header">
    ...
    <div class="galeria-port">
        <div align="center" class="imagen-port">
            <img src="../public/img/polea.jpg" height="900" width="1100"> 
        ...
        <div class="imagen-port">
            <img src="../public/img/PRESS PECHO INCLINADO.JPG" height="800" width="1100">
            <div class="hover-galeria">
        ...
        <div class="imagen-port">
            <img src="../public/img/pechomancuerna.jpg">
            <div class="hover-galeria">
